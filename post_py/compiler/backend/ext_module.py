...
def emit_ext_module(modules: list[Module], module_name: str) -> str:
    ...
    lines: list[str] = []
    w = lines.append
    w("/* AUTO-GENERATED by Post-Py reference compiler. DO NOT EDIT. */")
    ...
    w(f"    {_c_string('Post-Py compiled extension module.')},")
    w("    -1,")
    ...
    for py_name, fn in registrations:
        ...
        doc = _c_string(fn.doc or f"Post-Py ufunc `{py_name}`.")
        sig = fn.ufunc_sig
        assert sig is not None
