...
# The floor-division helper is owned by dimexpr (the module that renders `//`
# to C), so this preamble and the ext_module shim share one definition.
_PREAMBLE = _PREAMBLE_HEAD + dimexpr.FLOORDIV_SI_C + _PREAMBLE_TAIL
