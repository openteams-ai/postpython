...
This is the simplest non-trivial vectorized reduction over a single shared
core dimension.  It demonstrates:

  * The @guvectorize decorator with a reduction signature.
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"batch dot:\n{dot.as_numpy_ufunc()(A, B)}")  # expected: [2. 3.]
    except ImportError:
